...
<div class="tvshow-info border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
        <div class="flex-none">
            <img src="{{ $tvshow['poster_path'] }}" class="md:w-96 md-64 " alt="">
        </div>
        <div class="md:ml-24">
            ...
            <div class="flex flex-wrap items-center text-gray-400 text-sm">
                ...
                {{-- <span>created by {{ $tvshow['created_by'] }}</span> --}}
            </div>
    ...
    <div class="container mx-auto px-4 py-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
            ...
            <div class="mt-8 ">
                ...
                <div class="mt-12">
                    <a href="{{ route('actors.show',$cast['id']) }}" class="text-white font-semibold">{{ $cast['name'] }}</a>
